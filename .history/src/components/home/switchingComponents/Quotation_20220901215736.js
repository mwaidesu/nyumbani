  ...
  return (
    <div className="quote">
      ...
      <div className="row flex mb-2">
        ...
        <p className="col ml-4 text-2xl">{formData.mover.id}</p>
      </div>
      ...
      <div className="row flex my-3">
        <p className="col text-2xl">User_id:</p>
        <p className="col ml-4 text-2xl">{formData.user_id}</p>
      </div>
