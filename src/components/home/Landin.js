        ...
        <div className='w-full md:w-1/2 h-full flex justify-center items-center'>
            <div className='bg-black/50 rounded-3xl h-1/2 w-10/12 md:w-3/4'>
              ...
              <div className='pl-5 flex justify-evenly'>
                ...
                <Link to="/signin"><button type='submit' className='bg-yellow-500 rounded p-3 gap-4 hover:text-red-700'>Sign In</button></Link>
                <Link to="/signup">
                <button type='submit' className='bg-yellow-500 rounded p-3 gap-4 hover:text-red-700'>Sign Up</button></Link>
