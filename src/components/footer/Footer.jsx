...
<footer className="bg-gray-100 dark:bg-gray-900 mt-4">
    ...
    <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">NyumbaniMove™</a>. All Rights Reserved.
        </span>
